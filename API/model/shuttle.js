...
module.exports.getShuttlesByEvent = async (eventId, client) => {
    return await client.query('SELECT * FROM shuttle WHERE eventId = $1', [eventId]);
}
...
module.exports.deleteShuttlesByEvent = async (eventId, client) => {
    return await client.query('DELETE FROM shuttle WHERE eventId = $1', [eventId]);
}
